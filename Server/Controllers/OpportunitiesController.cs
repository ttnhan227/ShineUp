...
public class OpportunitiesController : ControllerBase
{
    ...
    public async Task<IActionResult> GetOpportunityApplications(int opportunityId)
    {
        try
        {
            ...
            {
                return NotFound(new
                    { message = "Opportunity not found or you don't have permission to view applications" });
            }
        ...
        [FromBody] UpdateOpportunityApplicationDTO updateDto)
    {
        try
        {
            ...
            var application =
                await _opportunityRepository.UpdateApplicationStatusAsync(applicationId, updateDto, userId);
            ...
            switch (status)
            {
                case "pending":
                    notificationMessage =
                        $"Thank you for applying to '{opportunityTitle}'. We've received your application and will review it shortly.";
                ...
                case "reviewing":
                    notificationMessage =
                        $"Great news! Your application for '{opportunityTitle}' is currently under review by our team.";
                ...
                case "shortlisted":
                    notificationMessage =
                        $"Congratulations! Your application for '{opportunityTitle}' has been shortlisted. We'll be in touch soon with next steps.";
                ...
                case "interviewing":
                    notificationMessage =
                        $"We're excited to move forward with your application! Let's schedule an interview for the '{opportunityTitle}' position.";
                ...
                case "accepted":
                    notificationMessage =
                        $"Congratulations! We're thrilled to offer you the '{opportunityTitle}' position. Please check your email for the offer details.";
                ...
                case "rejected":
                    notificationMessage =
                        $"Thank you for applying to '{opportunityTitle}'. Unfortunately, we've decided to move forward with other candidates at this time.";
                ...
                default:
                    notificationMessage =
                        $"There's been an update to your application for '{opportunityTitle}'. Status: {updateDto.Status}";
                    emailSubject = $"Update on Your Application for {opportunityTitle}";
                    emailBody = $"""
        ...
        catch (Exception ex)
        {
            ...
            return StatusCode(StatusCodes.Status500InternalServerError,
                new { message = "An error occurred while updating the application status" });
        }
    }
    ...
    public async Task<IActionResult> UpdateStatus(int id)
    {
        try
        {
            ...
            if (string.IsNullOrEmpty(status))
            {
                ...
                return BadRequest(new
                    { message = "Status is required. Valid values are: Open, Closed, Draft, Paused" });
            }
            ...
            if (result == null)
            {
                ...
                return StatusCode(StatusCodes.Status500InternalServerError,
                    new { message = "Error updating opportunity status" });
            }
        ...
        catch (Exception ex)
        {
            ...
            return StatusCode(StatusCodes.Status500InternalServerError,
                new { message = "An error occurred while updating the opportunity status" });
        }
    }
}