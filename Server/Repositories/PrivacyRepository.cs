...
namespace Server.Repositories
{
    public class PrivacyRepository : IPrivacyRepository
    {
        ...
        public async Task<Privacy?> GetByIdAsync(int id) => await _context.Privacies.FindAsync(id);
        public async Task<List<Privacy>> GetAllAsync() => await _context.Privacies.ToListAsync();
